<template>
    ...
    <main class="content-area bg-gray-50 p-6">
        <div class="max-w-8xl mx-auto">
            <h2 id="welcome-heading" class="text-3xl font-bold text-gray-900 mb-2">Welcome back {{ userData.name ?? ''
                }}!</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="card p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ itemsCardEvent?.jumlahEvent }}</p>
                </div>
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ itemsCardEvent?.jumlahEventMendatang }}</p>
                </div>
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div
                    ...
                    <p class="text-gray-600 text-sm mb-1">Event Berlangsung</p>
                    <p class="text-3xl font-bold text-gray-900">{{ itemsCardEvent?.jumlahEventBerlangsung }}</p>
                </div>
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div
                    ...
                    <p class="text-gray-600 text-sm mb-1">Skor Event Terakhir</p>
                    <p class="text-3xl font-bold text-gray-900">{{ itemsCardEvent?.skorEventTerakhir }}</p>
                </div>
            </div>
            ...
            <div class="w-full mb-8" v-if="jadwalActive">
                <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                    <div v-for="item in jadwalActive" :key="item.id"
                        ...
                        <!-- FOOTER -->
                        <div class="px-4 py-4 bg-gray-50 rounded-b-2xl flex justify-between items-center">
