...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            height: 100%;
            width: 260px;
            /* Or whatever width it's supposed to be */
            background: linear-gradient(180deg, #0e74e9ff 0%, #0251c7ff 100%);
            /* Default from JS */
            z-index: 100;
        ...
        .submenu.open {
            max-height: 500px;
            /* Or a value larger than any submenu */
        }
...
<body>
    ...
    <noscript>
        <div style="padding: 20px; text-align: center;">
            Aplikasi ini memerlukan JavaScript untuk berjalan. Silakan aktifkan JavaScript di browser Anda.
        </div>
    </noscript>
</body>
<script>
    const defaultConfig = {
        ...
        sidebar_color: '#2782eaff',
        card_color: '#ffffff',
        text_color: '#111827',
        accent_color: '#1667bdff'
    };
